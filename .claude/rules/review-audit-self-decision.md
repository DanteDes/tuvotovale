...
Rules for the orchestrator (main) session when evaluating output or findings returned by a
sub-agent. It governs how the orchestrator reacts to that output — it is not a guide for the sub-agents themselves, and not a
brainstorming or human-facing rule.
